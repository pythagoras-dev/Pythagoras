...
from .._000_supporting_utilities import get_hash_signature, get_node_signature
...
class StorableFn(OrdinaryFn):
    ...
    StorableFn extends OrdinaryFn with content-addressable storage capabilities.
    Each function is automatically assigned a ValueAddr based on its normalized
    source code, enabling persistent storage and retrieval from DataPortals.
    """
    ...
    def _persist_initial_config_params(self, portal:DataPortal) -> None:
        """Persist function-specific configuration parameters to a portal.
