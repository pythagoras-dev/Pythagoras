...
This subpackage extends DataPortal with comprehensive logging capabilities,
...
Core Concepts
-------------
**LoggingCodePortal**: Extends DataPortal with application-level and
...
StorableFn with automatic logging of execution attempts, results, exceptions,
