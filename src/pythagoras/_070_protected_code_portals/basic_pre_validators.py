...
def _check_python_package_and_install_if_needed(
    ...
    try:
        ...
        if (not address in portal._portal_config_settings
                or portal._portal_config_settings[address] < time.time() - 600):
            portal._portal_config_settings[address] = time.time()
