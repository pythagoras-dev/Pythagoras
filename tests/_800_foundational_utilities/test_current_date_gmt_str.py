from pythagoras._800_foundational_utilities.current_date_gmt_str import (
...
def test_current_date_gmt_string_all_months():
    ...
    for month in range(1, 13):
        ...
        with patch('pythagoras._800_foundational_utilities.current_date_gmt_str.datetime') as mock_datetime:
