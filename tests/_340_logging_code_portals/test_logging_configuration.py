...
from pythagoras._340_logging_code_portals import (
...
def test_portal_and_fn_config(tmpdir,f,p):
    ...
    with _PortalTester(LoggingCodePortal, tmpdir
        ...
        assert len(t.portal._portal_config_settings) == 1 - int(p==KEEP_CURRENT)
        ...
        assert len(t.portal._portal_config_settings) == 2 - int(p==KEEP_CURRENT) - int(f==KEEP_CURRENT)
